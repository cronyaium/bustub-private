...
auto AggregationExecutor::Next(Tuple *tuple, RID *rid) -> bool {
  if (aht_iterator_ != aht_.End()) {
    ...
    output.insert(output.end(), std::make_move_iterator(key.group_bys_.begin()),
                  std::make_move_iterator(key.group_bys_.end()));
    output.insert(output.end(), std::make_move_iterator(value.aggregates_.begin()),
                  std::make_move_iterator(value.aggregates_.end()));
